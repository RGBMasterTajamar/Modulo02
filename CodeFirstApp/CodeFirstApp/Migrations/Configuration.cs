namespace CodeFirstApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CodeFirstApp.DbContext.Context>
    {
        ...
        protected override void Seed(CodeFirstApp.DbContext.Context context)
        {
